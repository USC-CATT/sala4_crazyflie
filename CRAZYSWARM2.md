...
A more in-depth overview can be found at the [Crazyswarm2 documentation](https://imrclab.github.io/crazyswarm2/overview.html)
...
The data pipeline of the Crazyswarm2 cflib backend, including its ROS2 python api and controlling on the actual drone looks like this:
 ...
 `Crazyswarm2 (ROS2 API) -> crazyswarm2/crazyflie_py/crazyflie_py/crazyflie.py -> crazyswarm2/crazyflie/scripts/crazyflie_server.py -> cflib -> Drone`
